      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        ...
        <Section>
          <WorkGridItem id="Statisto" title="statisto" thumbnail={statisto}>
            Statisto is a landing page designed with a visually appealing and
            modern look.
          </WorkGridItem>
        </Section>

        <Section delay={0.1}>
          <WorkGridItem id="Boiswap" title="boiswap" thumbnail={boiswap}>
            Boiswap is a cryptocurrency landing page that provides a
            user-friendly interface for investors and enthusiasts in the crypto
            world.
          </WorkGridItem>
        </Section>
        ...
        <Section delay={0.1}>
          <WorkGridItem id="Omnifood" thumbnail={omnifood} title="omnifood">
            Omnifood is an online food ordering website that offers a wide range
            of features and boasts a sleek and modern design.
          </WorkGridItem>
        </Section>
        ...
        <Section delay={0.1}>
          ...
          >
            Coffee-Shop is a front-end website project designed to showcase an
            inviting and cozy coffee shop
          </WorkGridItem>
        </Section>
        ...
        <Section delay={0.1}>
          <WorkGridItem
            id="Sneakers"
            thumbnail={ecommerceNikeShoes}
            title="sneakers"
          >
            Sneakers is a front-end website project designed to showcase and
            sell Nike brand sneakers
          </WorkGridItem>
        </Section>
      </SimpleGrid>
    </Container>
